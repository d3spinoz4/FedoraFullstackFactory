...
class benfordslaw:
    ...
    def __init__(self, alpha=0.05, method='chi2', pos=1, verbose=3):
        ...
        pos : int [-9,..,9], (default: 1).
            Digit position to be analyzed. 1: first digit, 2: second digit etc. -1: the last position, -2: second last digit etc
    ...
    # Plot
    def plot(self, title='', fontsize=16, barcolor='black', barwidth=0.3, label='Empirical distribution', figsize=(15, 8), save_file = ''):
...
def create_app():
    app = Flask(__name__)
    # View at http://localhost:5000/_debug
    Debug(app)
    #logging.basicConfig(level=logging.DEBUG)
    # handler = logging.FileHandler('/tmp/app.log')  # errors logged to this file
